...
public class DeletePasswordEspressoTest {
    ...
    public void DeletePassword(){
        ...
        onView(withId(R.id.password_remove)).perform(
                new ViewAction() {
                    @Override
                    public Matcher<View> getConstraints() {
                        return ViewMatchers.isEnabled(); //no constraints
        ...
        onView(withId(R.id.password_request)).check(matches(isFocusable()));
        onView(withId(R.id.password_request)).perform(clearText(), typeText(mWrongConfirmPassword), closeSoftKeyboard());
        onView(withId(R.id.password_request)).check(matches(withText(mWrongConfirmPassword)));
        ...
        onView(withId(R.id.password_request)).check(matches(isFocusable()));
        onView(withId(R.id.password_request)).perform(clearText(), typeText(mPassword), closeSoftKeyboard());
        onView(withId(R.id.password_request)).check(matches(withText(mPassword)));
